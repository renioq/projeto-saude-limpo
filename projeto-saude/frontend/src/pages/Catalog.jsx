...
const Catalog = () => {
  ...
  const [detalhes, setDetalhes] = useState({}); // detalhes de unidades individuais

  // Busca unidades com base nos filtros fornecidos
  ...
  // Busca detalhes de uma unidade específica (via placeId)
        ...
        {units.map((unit, index) => (
          <li key={index} className="card">
            ...
            {!detalhes[unit.place_id] ? (
              <button onClick={() => buscarDetalhes(unit.place_id)}>Ver mais detalhes</button>
            ) : (
